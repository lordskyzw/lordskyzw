...
- **Case Wisdom** • **Practical Mathematics** • **Applied Philosophy**
- **Luck** & a little **Computer Science Voodoo**

### ⚙️ Tools & Infrastructure
- **Cognition**: 12 Watt neuromorphic neural network
- **Access**: Unlimited and uninterrupted access to the internet
- **Drive**: Stubborn will power & an end goal oriented intent

### 🌐 Networking
- Most of my friendships are built on **information flow**

---

## Public Projects

### ⚖️ ![Alignment](https://img.shields.io/badge/Alignment-Lawful%20Good-blue) [Zimra](https://github.com/lordskyzw/zimra)
An open-source python library which commoditizes electronic tax compliance in Zimbabwe. (lawfully good)

### 💀 ![Alignment](https://img.shields.io/badge/Alignment-Chaotic%20Evil-red) [Network Automation Tools](https://github.com/lordskyzw/chroma-stone-research)
Python scripts for exploring MNO vulnerabilities in Zimbabwe. (chaotic evil)
